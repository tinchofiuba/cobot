...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.widget.setGeometry(QtCore.QRect(12, 13, 191, 161))
        ...
        self.le_nombre_cobot = QtWidgets.QLineEdit(self.widget)
        ...
        self.hs_numero_DOF = QtWidgets.QSlider(self.widget)
        ...
        self.l_valor_numero_DOF = QtWidgets.QLabel(self.widget)
        ...
        self.le_RPM_cobot = QtWidgets.QLineEdit(self.widget)
        ...
        self.widget1.setGeometry(QtCore.QRect(13, 195, 191, 55))
        ...
        self.le_largo_eslavon = QtWidgets.QLineEdit(self.widget1)
        ...
        self.pb_seleccion_eje = QtWidgets.QPushButton(self.widget1)
        ...
        self.le_posicion_absoluta_eslavon = QtWidgets.QLineEdit(self.widget1)
        ...
        self.widget2.setGeometry(QtCore.QRect(14, 35, 190, 153))
        ...
        self.hs_selector_DOF = QtWidgets.QSlider(self.widget2)
        ...
        self.l_valor_seleccion_DOF = QtWidgets.QLabel(self.widget2)
        ...
        self.le_pin_enable_eslavon = QtWidgets.QLineEdit(self.widget2)
        ...
        self.le_pin_pasos_eslavon = QtWidgets.QLineEdit(self.widget2)
        ...
        self.le_pin_direccion_eslavon = QtWidgets.QLineEdit(self.widget2)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 191, 29))
        self.layoutWidget.setObjectName("layoutWidget")
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout(self.layoutWidget)
        self.horizontalLayout_7.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.pb_guardar_eslavon = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 30, 431, 71))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.gridLayout = QtWidgets.QGridLayout(self.layoutWidget1)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.pb_tipo_controlador = QtWidgets.QPushButton(self.layoutWidget1)
        self.pb_tipo_controlador.setObjectName("pb_tipo_controlador")
        self.gridLayout.addWidget(self.pb_tipo_controlador, 0, 0, 1, 1)
        self.pb_setear_cobot = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.l_seteo_cobot = QtWidgets.QLabel(self.layoutWidget1)
        self.l_seteo_cobot.setObjectName("l_seteo_cobot")
        self.gridLayout.addWidget(self.l_seteo_cobot, 0, 2, 1, 1)
        self.pb_conectar_controlador = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.l_estado_de_conexion = QtWidgets.QLabel(self.layoutWidget1)
        ...
        self.layoutWidget3 = QtWidgets.QWidget(self.groupBox_movimientos)
        self.layoutWidget3.setGeometry(QtCore.QRect(10, 30, 196, 411))
        ...
        self.lw_lista_movimientos = QtWidgets.QListWidget(self.layoutWidget3)
        ...
        self.pb_agregar_movimiento = QtWidgets.QPushButton(self.layoutWidget3)
        ...
        self.pb_remover_movimiento = QtWidgets.QPushButton(self.layoutWidget3)
        ...
        self.pb_borrar_todo_movimiento = QtWidgets.QPushButton(self.layoutWidget3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(150)
        sizePolicy.setVerticalStretch(30)
        ...
        self.pb_enviar_ordenes = QtWidgets.QPushButton(self.layoutWidget3)
